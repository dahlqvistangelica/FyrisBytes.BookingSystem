...
{
    static void NewBooking(DataManager dataManager) //Tai
    {
        Console.Clear();
    ...
    static void ChangeBooking(DataManager datamanager) //Tai
    {
    ...
    static void DeleteBooking(DataManager dataManager)//Tai
    {
        DateTime date = UserInputManager.UserCreateDateTime();
    ...
    static void ListAllBookings(DataManager dataManager)
    {
        foreach (var item in dataManager.AllBookings)
        {
